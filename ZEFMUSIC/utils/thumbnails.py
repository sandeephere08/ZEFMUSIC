...
async def get_thumb(videoid):
    ...
    try:
        arial = ImageFont.truetype("ZEFMUSIC/assets/font2.ttf", 30)
        font = ImageFont.truetype("ZEFMUSIC/assets/font.ttf", 30)
        title_font = ImageFont.truetype("ZEFMUSIC/assets/font3.ttf", 45)
    except:
    ...
    play_icons = Image.open("ZEFMUSIC/assets/play_icons.png")
